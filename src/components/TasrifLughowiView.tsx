...
export default function TasrifLughowiView({
  ...
  return (
    <div className="space-y-6">
      {/* Grouped Tab Navigation Escalation */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className={`p-4 rounded-2xl border transition-all ${
          ...
          <div className="flex items-center justify-between mb-3 pb-1.5 border-b border-dashed border-emerald-500/20">
            <div className="flex items-center gap-1.5">
              <span className="w-1.5 h-3 rounded-full bg-emerald-500 animate-pulse"></span>
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              { id: "amar_nahi", name: "Amar & Nahi", desc: "Perintah & Larangan (12 D)", arabic: "الأمر والنهي", icon: Award },
            ].map((item) => {
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className={`p-1.5 rounded-lg ${
                      active ? "bg-emerald-500/25 text-emerald-400" : "bg-slate-500/10 text-slate-400"
                    }`}>
        ...
        <div className={`p-4 rounded-2xl border transition-all ${
          ...
          <div className="flex items-center justify-between mb-3 pb-1.5 border-b border-dashed border-indigo-500/20">
            <div className="flex items-center gap-1.5">
              <span className="w-1.5 h-3 rounded-full bg-indigo-500 animate-pulse"></span>
              <span className={`text-[10px] font-bold tracking-wider uppercase ${
                appTheme === "light" ? "text-slate-600" : "text-slate-400"
            ...
            {[
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className={`p-1.5 rounded-lg ${
                      active ? "bg-indigo-500/25 text-indigo-400" : "bg-slate-500/10 text-slate-400"
                    }`}>
                      <Icon className="w-4 h-4" />
                    </div>
                    <div className="min-w-0">
        ...
        <div className={`p-4 rounded-2xl border transition-all ${
          ...
          <div className="flex items-center justify-between mb-3 pb-1.5 border-b border-dashed border-amber-500/20">
            <div className="flex items-center gap-1.5">
              <span className="w-1.5 h-3 rounded-full bg-amber-500 animate-pulse"></span>
              <span className={`text-[10px] font-bold tracking-wider uppercase ${
                appTheme === "light" ? "text-slate-600" : "text-slate-400"
              }`}>Kondisi & Alat</span>
            </div>
            ...
            {[
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className={`p-1.5 rounded-lg ${
                      active ? "bg-amber-500/25 text-amber-450" : "bg-slate-500/10 text-slate-400"
                    }`}>
                      <Icon className="w-4 h-4" />
                    </div>
                    <div className="min-w-0">
