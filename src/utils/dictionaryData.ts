...
export const PRESET_DICTIONARY: DictionaryEntry[] = [
  ...
  },
  {
    ...
    reference: "Kamus Al-Munawwir, Tajul 'Arus",
    notes: "Analisis: Sangat kaya akan wazan masdar. 'Hayāh' eksistensi biologis/ruhani, 'Hayaa' rasa malu positif pelindung akhlak. Sifat musyabihat hayy berarti senantiasa hidup bugar. Dikelompokkan sebagai Mudho'af karena Ain dan Lam Fi'il berupa huruf yang sejenis (Ya')."
  },
  {
    id: "wafa",
