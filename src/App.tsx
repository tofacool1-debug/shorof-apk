...
const styles = StyleSheet.create({
  ...
  "expo": {
    ...
    "ios": {
      "supportsTablet": true,
      "bundleIdentifier": "com.shorof.digital",
      "infoPlist": {
...
3. Hubungkan ke Cloud Expo Anda:
   \`\`\`bash
   eas login
   eas project:init --id de3329e9-ed7a-4005-abfa-7bda2599b5d4
   \`\`\`
...
module.exports = config;`
  ...
  const handleRunMetroStart = () => {
    ...
    setTimeout(() => {
      ...
      logTerminal("  › Mode Ekspos Server Terowongan: https://u.expo.dev/de3329e9-ed7a-4005-abfa-7bda2599b5d4");
  ...
  const handleStartEasBuild = (platform: "android" | "ios") => {
    ...
    const logList = [
      ...
      `[eas] Sinkronisasi project ID: de3329e9-ed7a-4005-abfa-7bda2599b5d4...`,
